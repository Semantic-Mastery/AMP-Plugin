...
class AMPsCreator_KSES {
	...
	/**
 	 * There are tags that will be converted into amps-specific versions
 	 */
	...
	static private function get_blacklisted_tags() {
		return array(
			...
			// We are running kses before AMPsCreator conversion due to a kses bug (#34105-core). Technically, conversion should catch the tags and shouldn't be something we need to worry about.
			//'img',
			//'video',
			//'audio',
			//'iframe',
