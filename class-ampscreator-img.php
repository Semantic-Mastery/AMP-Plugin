...
class AMP_Img_Converter extends AMPsCreator_Converter {
	...
	public function convert( $amps_attributes = array() ) {
		...
		foreach ( $images as $image ) {
			...
			if ( ! empty( $attributes['src'] ) ) {
				...
				$new_img .= sprintf( '<amps-img %s></amps-img>', $this->build_attributes_string( $attributes ) );
			}
...
class AMPsCreator_Img_Dimension_Extractor {
